...
export const userOwnerProfile = asyncHandler(async (req, res) => {
...
export const mutalConnection = asyncHandler(async (req, res, next) => {
  ...
  return res.status(200).json({
    status: "success", message: "The connection has been removed successfully"
    , mutualConnectionsCount: mutualConnections.length, mutualConnections
  });
}) 
